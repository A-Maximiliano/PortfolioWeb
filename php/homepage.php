                    ...
                    <div class="timeline-image"><img class="rounded-circle img-fluid" src="../resources/img/8.jpg" alt="..." /></div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                ...
                                <h4 class="subheading">Septiembre 2016 - Noviembre 2017</h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted">• Mantenimiento del sistema SAP Business ERP.</p>
                                <p class="text-muted">• Ingresar nuevos clientes al sistema.</p>
                                <p class="text-muted">• Programar y coordinar reuniones para los gerentes.</p>
                                <p class="text-muted">• Gestionar los informes de viajes y gastos de los miembros del equipo.</p>
                            </div>
                        </div>
                    </li>
            ...
            <div class="container px-4 px-lg-5">
                <div class="content-section-heading">
                   <!-- <h3 class="text-secondary mb-0">Experiencia</h3> -->
                    <h2 class="mb-5">Cursos y Certificaciones</h2>
                </div>
                ...
                <div class="row gx-4 gx-lg-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <span class="service-icon rounded-circle mx-auto mb-3"><i class="icon-screen-tablet"></i></span>
                        <h4><strong>MICITT CECI - Desarrollo de Aplicaciones Android 2021.</strong></h4>
                       
                    </div>

                    <div class="col-lg-3 col-md-6">
                        <span class="service-icon rounded-circle mx-auto mb-3"><i class="icon-user-following"></i></span>
                        <h4><strong>FATLA - Curso Presencia Digital e Imagen Corporativa 2020.</strong></h4>
                        
                    </div>
                    
                    <div class="col-lg-3 col-md-6">
                        <span class="service-icon rounded-circle mx-auto mb-3"><i class="icon-settings"></i></span>
                        <h4><strong>	INA - Técnico Reparación de Computadoras 2020</strong></h4>
                        
                    </div>

                    <div class="col-lg-3 col-md-6">
                        <span class="service-icon rounded-circle mx-auto mb-3"><i class="icon-social-google"></i></span>
                        <h4><strong>GOOGLE - Curso de Cloud Computing 2019</strong></h4>
                        
                    </div>

                    <div class="col-lg-3 col-md-6">
                        <span class="service-icon rounded-circle mx-auto mb-3"><i class="icon-social-google"></i></span>
                        <h4><strong>GOOGLE - Curso Desarrollo de Apps Móviles 2019</strong></h4>
     ...
     <div class="portfolio-modal modal fade" id="portfolioModal1" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="close-modal" data-bs-dismiss="modal"><img src="../resources/img/back.png" alt="Cerrar" /></div>
                    <div class="container">
        ...
        <section class="page-section" id="contact">
            <div class="container">
                ...
                <form id="contactForm" action="https://formsubmit.co/240d701791b311ec246992f39f1a98cd" method="POST"/>
                    <div class="row align-items-stretch mb-5">
                        <div class="col-md-6">
                            <div class="form-group">
                                <!-- Name input-->
                                <input class="form-control" id="name" type="text" placeholder="Nombre *" name="name" data-sb-validations="required" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="invalid-feedback" data-sb-feedback="email:required">Su email es requerido.</div>
                                <div class="invalid-feedback" data-sb-feedback="email:email">El email no es válido.</div>
                            </div>
                            <div class="form-group mb-md-0">
                                <!-- Phone number input-->
                                <input class="form-control" id="phone" type="tel" name="phone" placeholder="Teléfono *" data-sb-validations="required" />
                                <div class="invalid-feedback" data-sb-feedback="phone:required">Su teléfono es requerido.</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-group-textarea mb-md-0">
                                <!-- Message input-->
                                <textarea class="form-control" id="message" name="message" placeholder="Mensaje *" data-sb-validations="required"></textarea>
                                <div class="invalid-feedback" data-sb-feedback="message:required">Por favor escriba su mensaje.</div>
                            </div>
                        </div>

                        <input type="hidden" name="_next" value="http://localhost/PortafolioWebProfesional/PortfolioWeb/php/homepage.php">
